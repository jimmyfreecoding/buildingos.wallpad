<template>
  ...
  <div v-if="!(obj.type==='wc' || obj.type==='wcw')&&!isWuxiui" class="main-box flex-col animate__animated">
    ...
    <div style="position: absolute;top: 0;width: 100%;padding:50px 100px" class="flex-row justify-between">
      <Logo :class="class1" class="animate__animated" ref="logoCom" ></Logo>
      <LocalTime :class="class2" class="animate__animated "  ></LocalTime>
    </div>

    <div   style="position: absolute;top: 160px;width: 100%;padding:50px 100px" class="content flex-row justify-between">
      <div class="left flex-col justify-between">
        <IndexTitle :img="iconWen" :title="obj.floor+' '+obj.code+'区 室内'"></IndexTitle>
        <div class="flex-row align-end justify-between">
          <div class="title-num">{{ (inside.temperature-1).toFixed(0)}}<span style="font-size:60px;line-height: 100px;vertical-align: text-top;display:inline-block;width:0px">℃</span></div>
        ...
        <div class="flex-row" style="gap:20px">
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="inside.formaldehyde * 1000"  :stroke-width="12">
          ...
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="inside.co2/20"  :stroke-width="12">
          ...
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="(inside.pm25/250) * 100"  :stroke-width="12">
      ...
      <div class="right  flex-col justify-between">
        <IndexTitle title="室外"></IndexTitle>
        <div class="">
          <div class="title-num font200">{{ outside.temperatureNum }}<span style="font-size:50px;line-height: 100px;vertical-align: text-top;display:inline-block;width:0px">℃</span></div>
          <IndexTitle :img="iconAir" title="空气质量"></IndexTitle>
        </div>
        <div class="flex-row" style="gap:20px">
          <div class="zhibiao">
            <div class="title-box flex-row align-center  justify-between">
            ...
            <el-progress color="#00000000" :percentage="outside.AIQ"  :stroke-width="12">
          ...
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="(outside.pm25/100) * 100"  :stroke-width="12">
    ...
    <div  @click="showIndex(0)" class="bottom-all flex-col align-center justify-center">
      <img class="icon" src="@/assets/images/iconall.png"/>
      <div>全部功能</div>
    </div>
    <div   class="bottom-box flex-row align-center justify-around">
      ...
      <div @click="showIndex(2)" style="margin-right:2%" class="flex-row justify-center">
        <img class="icon" src="@/assets/images/iconzm.png"/>
        <div>照明空调 </div>
      </div>
      <div @click="showIndex(1)" style="margin-left:6%" class="flex-row justify-center">
    ...
    <div   @click="dialogSOS=true" class="bottom-soc flex-col align-center justify-center">SOS</div>
    ...
    >
      <div class="index-box flex-row">
        ...
        <leftNav :style="(tabIndex===0 || tabIndex==4)?'width:220px;z-index:3':'width:1220px;z-index:3'" :active="tabIndex" @clickChild="navFun" :data ="data"></leftNav>
...
<!--          <div id="mapId" style="height:800px!important;width:750px!important;position:relative!important;z-index:2" ></div>-->
  ...
  <div v-if="obj.type==='wc' || obj.type==='wcw'" class="main-box flex-col animate__animated wc">
    <div style="position: absolute;top: 0;width: 100%;padding:50px 100px;z-index:1" class="flex-row justify-between">
      <Logo :class="class1" class="animate__animated" ref="logoCom" ></Logo>
      <LocalTime :class="class2" class="animate__animated "  ></LocalTime>
    </div>
    <div class="wc-box flex-col align-center">
      <div class="content flex-row align-center" >
        <div >
          ...
          <div class="border-bg" style="margin-top:40px;">
...
<!--        <img style="" class="bg" :src="wc"/>-->
          <div class="txt1" style="font-size:72px;left: -4%;">{{obj.floor}}{{obj.type ==='wc'?'':''}}</div>
          <div v-if="obj.type ==='wc'" class="txt4 flex-row align-center justify-between" style="left: 15%;">
            <div class="flex-row align-center">
              <div class="flex-row align-center" style="width:500px;justify-content: space-around;">
                <template v-for="(item,index) in wcmanStatusObj">
                <div  v-if="index>0 && index<8 && (wcmanStatusObj[index]===0 || wcmanStatusObj[index]===1)" :class="wcmanStatusObj[index]===0?'weizhi':'weizhi-active'"  style="width:72px;height:72px" ></div>
                </template>
<!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
<!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
<!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
              </div>
              <el-divider direction="vertical"/>
              <div v-if="wcmanStatusObj[9]===0" :class="wcmanStatusObj[9]===0?'weizhi':'weizhi-active'"  style="width:72px;height:72px" ></div>

              <!--              <div class="weizhi-active" style="width:64px;height:64px"></div>-->
            </div>
          </div>


          <div v-if="obj.type ==='wcw'"  class="txt4 flex-row align-center justify-between" style="left: 15%;">
            <div class="flex-row align-center">
              <div class="flex-row align-center" style="width:500px;justify-content: space-around;">
                <template v-for="(item,index) in wcwomanStatusObj">
                  <div  v-if="index>0 && index<8 && wcwomanStatusObj[index]===0" :class="wcwomanStatusObj[index]===0?'weizhi':'weizhi-active'"  style="width:72px;height:72px" ></div>
                </template>
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
              ...
              <el-divider direction="vertical"/>
              <div v-if="wcwomanStatusObj[9]===0" :class="wcwomanStatusObj[9]===0?'weizhi':'weizhi-active'"  style="width:64px;height:64px" ></div>
...
const setInitBg = ()=>{
  ...
  if(today){
    bgParams.type = 'video'
    bgParams.urls = [{url:'/wallpad/images/all.mp4'}]
    if(today ==='多云' || today ==='阴' || today.indexOf('雾')!==-1){
      bgParams.urls = [{url:'/wallpad/images/all.mp4'}]
    }else if(today ==='晴'){
      // console.info("+++++++++++++setInitBg+++++++++++++")
...
import wuxiu from '@/assets/images/wuxiu.png'
import wuxiuBg from '@/assets/images/wuxiuBg.jpg'
const publish = inject('publish') // 订阅信息
// bgParams:{
//   type: 'image',
//       urls:[{url:bg}]
...
.main-box{
  ...
  .content{
    ...
    .left{
      ...
      height: 632px;
      border-radius: 32px;
      border: var(--sys_radius-rounded-s, 2px) solid var(---, rgba(255, 255, 255, 0.80));
      background: linear-gradient(250deg, rgba(255, 255, 255, 0.00) 3.57%, rgba(255, 255, 255, 0.18) 59.54%, rgba(255, 255, 255, 0.20) 97.94%);
    ...
    .right{
      ...
      border-radius: 32px;
      border: var(--sys_radius-rounded-s, 2px) solid var(---, rgba(255, 255, 255, 0.80));
      background: linear-gradient(238deg, rgba(255, 255, 255, 0.00) 34.07%, rgba(255, 255, 255, 0.15) 63.53%, rgba(255, 255, 255, 0.20) 96.41%);
      backdrop-filter: blur(5px);
  ...
  .bottom-all{
    ...
    border-radius: 50%;
    background: linear-gradient(180.24deg, rgba(255, 255, 255, 0.1) 0.36%, rgba(255, 255, 255, 0.28) 35.22%, rgba(255, 255, 255, 0.2) 99.95%);
    .icon{
      width:44px;
  ...
  .bottom-box{
    width:calc(100% - 73px);
    height:116px;
    background:url('@/assets/images/bgBottom.png');
  ...
  .bottom-soc{
    width:103px;
    height:116px;
    background:url('@/assets/images/iconsos.png');
    background-size: 100% 116px;
    position: absolute;
    bottom:0;
    right:0;

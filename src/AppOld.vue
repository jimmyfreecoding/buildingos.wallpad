<template>
  ...
  <div v-if="!(obj.type==='wc' || obj.type==='wcw')&&!isWuxiui" class="main-box flex-col animate__animated">
    ...
    <div   style="position: absolute;top: 160px;width: 100%;padding:80px 100px" class="content flex-row justify-between">
      <div class="left flex-col justify-between">
        ...
        <div class="flex-row align-end justify-between">
          <div class="title-num">
            <span > {{ (inside.temperature-1).toFixed(0)}} <span class="font100">.{{(inside.temperature-1).toFixed(1).split(".")[1]}}</span></span>
          ...
          <div style="flex:1">
            ...
            <div class="title-num1">{{ inside.humidity }}% <span style="color:#3AAD81;margin-left:10px">舒适</span></div>
          </div>
        </div>
        <div class="flex-row" style="gap:20px">
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="inside.formaldehyde * 1000"  :stroke-width="4">
              <div text style="color:rgba(255,255,255,0.4);text-align: right;">{{ (inside.formaldehyde*1.230).toFixed(3)}}</div>
            </el-progress>
          </div>
          <div class="zhibiao">
            <div class="title-box flex-row align-center  justify-between">
            ...
            <el-progress color="#00000000" :percentage="inside.co2/20"  :stroke-width="4">
              <div text style="color:rgba(255,255,255,0.4);text-align: right;">{{ (inside.co2*1.800).toFixed(0) }}</div>
            </el-progress>
          </div>
          <div class="zhibiao">
            <div class="title-box flex-row align-center  justify-between">
            ...
            <el-progress color="#00000000" :percentage="(inside.pm25/250) * 100"  :stroke-width="4">
      ...
      <div class="right  flex-col justify-between">
        ...
        <div class="flex-row align-end">
          <div class="title-num">{{ outside.temperatureNum}}<span class="font100">.0</span><span style="font-size:60px;line-height: 100px;vertical-align: text-top;display:inline-block;width:0px">℃</span></div>
          <div style="flex:1">
        ...
        <div class="flex-row" style="gap:20px">
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="outside.AIQ"  :stroke-width="4">
          ...
          <div class="zhibiao">
            ...
            <el-progress color="#00000000" :percentage="(outside.pm25/100) * 100"  :stroke-width="4">
            ...
            <div class="flex-row align-center">
              <div class="flex-row align-center" style="width:500px;justify-content: space-around;">
                <template v-for="(item,index) in wcwomanStatusObj">
                  <div  v-if="index>0 && index<8 && (wcwomanStatusObj[index]===0 || wcwomanStatusObj[index]===1)"  :class="wcwomanStatusObj[index]===0?'weizhi':'weizhi-active'"  style="width:72px;height:72px" ></div>
                </template>
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
                <!--                <div class="weizhi" style="width:64px;height:64px"></div>-->
              ...
              <el-divider direction="vertical"/>
              <div v-if="wcwomanStatusObj[9]===0" :class="wcwomanStatusObj[9]===0?'weizhi':'weizhi-active'"  style="width:72px;height:72px" ></div>
      ...
      <div class="content1 flex-row align-center">
        ...
        <div class="border-bg zhibiao">
          ...
          <el-progress color="#00000000" :percentage="0"  :stroke-width="4">
            <div text style="font-size:32px;color:rgba(255,255,255,1);text-align: right;">{{ (toiletAir.h2s) }}mg/m³</div>
          </el-progress>
        </div>
        <div class="border-bg zhibiao">
          <div class="title-box flex-row align-center  justify-between">
        ...
        <div class="border-bg zhibiao">
          ...
          <el-progress color="#00000000" :percentage="toiletAir.nh3"  :stroke-width="4">
            <div text style="font-size:32px;color:rgba(255,255,255,1);text-align: right;">{{ (toiletAir.nh3*0.695).toFixed(3) }}mg/m³</div>
          </el-progress>
        </div>
...
const link = () =>{
  ...
  if(padObj.value.name===""){
    ...
    if(data) {
      ...
      // console.info('/iot/setting/get/device')
      // console.info({
      //   spaceCode:JSON.parse(data).space,
      //   floorAreaCode:JSON.parse(data).floorarea,
      //   floorCode:JSON.parse(data).floor,
...
getMessage((topic, message) => {
  ...
  if(obj.value.type ==='wcw' && topic.indexOf(`/iot/status/cleaning/HGH-WC/${obj.value.floorarea}/${obj.value.floor}/TWOMAN`)!==-1){
    // /iot/status/cleaning/HGH-WC/A4/42F/TMAN
    let message1 = JSON.parse(message)
    console.info("获取到了最新保洁信息")
    console.info(message1)
